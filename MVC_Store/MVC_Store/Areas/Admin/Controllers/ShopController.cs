...
namespace MVC_Store.Areas.Admin.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult AddProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            TempData["SM"] = "You added a product";
            ...
            var pathString3 = Path.Combine(originalDirectory.ToString(), "Products\\" + id.ToString() +
                "\\Thumbs");
            var pathString4 = Path.Combine(originalDirectory.ToString(), "Products\\" + id.ToString() +
                "\\Gallery");
            var pathString5 = Path.Combine(originalDirectory.ToString(), "Products\\" + id.ToString() +
                "\\Gallery\\Thumbs");
            ...
            if (file != null && file.ContentLength > 0)
            {
                    ...
                    ext != "image/png")
                {
                    ...
                    {
                        model.Categories = new SelectList(db.Categories.ToList(), "Id", "Name");
                        ModelState.AddModelError("", "Image wasn't uploaded: wrong image extension");
                        return View(model);
                    }
                }
        ...
        public ActionResult EditProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            TempData["SM"] = "You edited the product!";
        ...
        public void SaveGalleryImages(int id)
        {
            foreach (string fileName in Request.Files)
            {
                ...
                if (file != null && file.ContentLength > 0)
                {
                    var originalDiretory = new DirectoryInfo(string.Format($"{Server.MapPath(@"\")}Images\\Uploads"));

                    string pathString1 = Path.Combine(originalDiretory.ToString(), "Products\\" + id.ToString() + "\\Gallery");
                    string pathString2 = Path.Combine(originalDiretory.ToString(), "Products\\" + id.ToString() + "\\Gallery\\Thumbs");
        ...
        //POST: Admin/Shop/DeleteImages/id/imageName
